<?php
include 'class.php';
if(empty($_SESSION['anggota'])) echo "<script>alert('You need to log in first');location='login.php'</script>";
?>
<?php  
				...
				<div class="container-fluid">
					<div class="navbar-collapse collapse in">
						<ul class="nav navbar-nav navbar-mobile">
							...
							<li class="logo">
								<a class="navbar-brand" href="#"><span class="highlight">DNCC</span> COM</a>
							</li>
							<li>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<a class="card card-banner card-green-light">
							<div class="card-body">
								...
								<div class="content">
									<div class="title"></div>
									<div class="value"><span class="sign"></span>Mobile</div>
								</div>
							</div>
						</a>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<a class="card card-banner card-yellow-light">
							<div class="card-body">
								...
								<div class="content">
									<div class="title"></div>
									<div class="value"><span class="sign"></span>Web</div>
								</div>
							</div>
						</a>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<a class="card card-banner card-green-light">
							<div class="card-body">
								...
								<div class="content">
									<div class="title"></div>
									<div class="value" style="font-size: 46px;"><span class="sign"></span>Multimedia</div>
								</div>
							</div>
						</a>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<a class="card card-banner card-yellow-light">
							<div class="card-body">
								...
								<div class="content">
									<div class="title"></div>
									<div class="value"><span class="sign"></span>Jaringan</div>
								</div>
							</div>
						</a>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<a class="card card-banner card-green-light">
							<div class="card-body">
								...
								<div class="content">
									<div class="title"></div>
									<div class="value"><span class="sign"></span>Dekstop</div>
								</div>
							</div>
						</a>
					</div>
					...
					<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
						<a class="card card-banner card-yellow-light">
							<div class="card-body">
								...
								<div class="content">
									<div class="title"></div>
									<div class="value" style="font-size: 46px;"><span class="sign"></span>Broadcast</div>
								</div>
							</div>
						</a>
					</div>
